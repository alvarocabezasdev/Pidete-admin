...
var Service = /** @class */ (function () {
    function Service(fireStore) {
        ...
        this.comanda = [];
        this.listado = [];
        this.productos = fireStore.collection(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].firebaseConfig.productos);
    }
    //PRODUCTOS
    ...
    Service.prototype.leerMesa = function (mesa) {
        switch (mesa) {
            case "mesa1":
                this.mesa = this.fireStore.collection(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].firebaseConfig.mesa1);
                break;
            case "mesa2":
                this.mesa = this.fireStore.collection(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].firebaseConfig.mesa2);
                break;
            case "mesa3":
                this.mesa = this.fireStore.collection(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].firebaseConfig.mesa3);
                break;
            case "mesa3":
                this.mesa = this.fireStore.collection(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].firebaseConfig.mesa4);
                break;
        }
    ...
    Service.prototype.getCuentaMesa = function (mesa) {
        ...
        switch (mesa) {
            case "mesa1":
                this.cuentaMesa = this.fireStore.collection(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].firebaseConfig.cuentaMesa1);
                break;
            case "mesa2":
                this.cuentaMesa = this.fireStore.collection(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].firebaseConfig.cuentaMesa2);
                break;
            case "mesa3":
                this.cuentaMesa = this.fireStore.collection(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].firebaseConfig.cuentaMesa3);
                break;
            case "mesa3":
                this.cuentaMesa = this.fireStore.collection(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].firebaseConfig.cuentaMesa4);
                break;
        }
    ...
    Service.prototype.resetCuentaMesa = function (mesa) {
        ...
        this.cuentaMesa.get().subscribe(function (querySnapshot) {
            querySnapshot.forEach(function (doc) {
                _this.mesa.doc(doc.id).update(cuenta);
            });
        });
    };
